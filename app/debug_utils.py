...
activity_types = {
    ...
    "reusable_container": {
        "name": "Used Reusable Container",
        "points": 2,
        "carbon_saved": 0.3,
    },
    "event_participation": {
        "name": "Attended Sustainability Event",
        "points": 15,
        "carbon_saved": 0.5,
    },
    "energy_saving": {
        "name": "Reported Energy Waste",
        "points": 8,
        "carbon_saved": 5.0,
    },
...
def generate_user_points():
    ...
    for user in users:
        ...
        user_points = UserPoints(
            user_id=user.id, total_points=total_points, green_score=green_score
        )
